...
import { Badge,MenuItem,Select,TextField,
    AppBar,Typography,Toolbar,IconButton,Box, 
    Button,Autocomplete, styled,alpha, useTheme,Menu } from '@mui/material'
...
function SearchBar(){
    ...
    function handleSearchChange(searchTerm){
        if(searchTerm){
            navigate(selectedCategory==="all"?`?searchTerm=${searchTerm}`:
